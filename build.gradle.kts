// colecteur-luckperms — a VaniaMetrics-<Name>-<v>.jar in build/libs/
//
...
dependencies {
    ...
    // @Plugin generates velocity-plugin.json: the processor lives in velocity-api.
...
// The jar name comes from "name:", not the entry-point class: the server repo's
// module list identifies modules by their plugin name — the one Bukkit shows.
