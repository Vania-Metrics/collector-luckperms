...
// from a sibling directory. The repo is cloned into .gradle/vania-core and included
...
dependencyResolutionManagement {
    ...
    repositories {
        ...
        // and its checksum verification fails while writing verification-metadata.xml
        // — or writes an incomplete file (gradle/gradle#32739, #26803, still open).
