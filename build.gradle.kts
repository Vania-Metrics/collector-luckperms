// collector-luckperms — a vania-metrics-collector-luckperms-<v>.jar in build/libs/
//
...
val generateBuildVersion by tasks.registering {
    ...
    outputs.dir(out)
    doLast {
        val file = out.get().file("fr/samflix/vaniametrics/module/luckperms/BuildVersion.java").asFile
